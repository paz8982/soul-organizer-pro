...
const he: Dict = {
  ...
  "archive.tagSearchPlaceholder": "חיפוש תגית…",
  "archive.mode.text": "טקסט",
  "archive.mode.tags": "תגיות",
  "archive.mode.smart": "חכם",
  "archive.textHint": "חיפוש לפי מילים — כל מילה תחפש בנפרד.",
  "archive.tagHint": "בחר תגית כדי לסנן פריטים.",
  "archive.clearFilters": "נקה סינון",
  "archive.noTags": "אין תגיות זמינות.",
  "archive.moreTags": "תגיות נוספות",
...
const en: Dict = {
  ...
  "archive.tagSearchPlaceholder": "Search by tag…",
  "archive.mode.text": "Text",
  "archive.mode.tags": "Tags",
  "archive.mode.smart": "Smart",
  "archive.textHint": "Word search — each word is matched separately.",
  "archive.tagHint": "Pick a tag to filter items.",
  "archive.clearFilters": "Clear filters",
  "archive.noTags": "No tags available.",
  "archive.moreTags": "more tags",
